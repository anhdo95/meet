Vue.component("mic-icon", {
  template: `
    <svg width="256" height="256" viewBox="0 0 256 256" v-on="$listeners">
      <g transform="translate(128 128) scale(0.72 0.72)">
        <g style="miter; stroke-miterlimit: 10; fill-rule: nonzero; opacity: 1;" transform="translate(-175.05 -175.05000000000004) scale(3.89 3.89)">
